...
!function ($) {
    ...
    BootstrapTable.LOCALES['en-US'] = {
        ...
        formatShowingRows: function (pageFrom, pageTo, totalRows) {
            return sprintf('显示第 %s到 %s 总共[%s]条记录', pageFrom, pageTo, totalRows);
        },
    ...
    BootstrapTable.prototype.initToolbar = function () {
        ...
        if (this.options.showRefresh) {
            html.push(sprintf('<button class="btn btn-default btn-refresh' + (this.options.iconSize == undefined ? '' :  ' btn-' + this.options.iconSize) + '" type="button" name="refresh" title="%s">',
